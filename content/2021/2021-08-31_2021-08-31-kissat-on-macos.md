...
NixOS 21.11のリリースに向けての総ざらえでマージされた。

## 2021-10-09

言われるがままにPR修正したのにone approveされたところで放置されてしまった。
`git rebase master; git push -f`したら中身は変わってないのだけど1週間ぶりに反応があった。
さあどうなるんだか &#x1F641;

~~結局approve されなかったので流産となりました。~~
